...
const ENEMY_BANNERS = {
  ...
  angrySpeaker: { src: "assets/enemies/angry-speaker-banner.png", position: "center 44%" },
  brokenAmp: { src: "assets/enemies/broken-amp-banner.png", position: "center 42%" },
  blackoutPhoenix: { src: "assets/enemies/blackout-phoenix-banner.png", position: "center 38%" },
  neonVoidIdol: { src: "assets/enemies/neon-void-idol-banner.png", position: "center 36%" },
  crowdCrusher: { src: "assets/enemies/crowd-crusher-banner.png", position: "center 42%" },
  feedbackPhantom: { src: "assets/enemies/feedback-phantom-banner.png", position: "center 40%" },
  stageSecurity: { src: "assets/enemies/stage-security-banner.png", position: "center 42%" },
  fuseGremlin: { src: "assets/enemies/fuse-gremlin-banner.png", position: "center 42%" },
  flickerBat: { src: "assets/enemies/flicker-bat-banner.png", position: "center 40%" },
  cableSerpent: { src: "assets/enemies/cable-serpent-banner.png", position: "center 45%" },
  blackoutBouncer: { src: "assets/enemies/blackout-bouncer-banner.png", position: "center 38%" },
  feedbackGolem: { src: "assets/enemies/feedback-golem-banner.png", position: "center 40%" },
  cableHydra: { src: "assets/enemies/cable-hydra-banner.png", position: "center 42%" },
  strobeWraith: { src: "assets/enemies/strobe-wraith-banner.png", position: "center 38%" },
  warehouseLightEater: { src: "assets/enemies/warehouse-light-eater-banner.png", position: "center 36%" },
  subwooferSlime: { src: "assets/enemies/subwoofer-slime-banner.png", position: "center 42%" },
  tremorMite: { src: "assets/enemies/tremor-mite-banner.png", position: "center 42%" },
  resonanceJellyfish: { src: "assets/enemies/resonance-jellyfish-banner.png", position: "center 40%" },
  bassBruiser: { src: "assets/enemies/bass-bruiser-banner.png", position: "center 38%" },
  resonanceMonk: { src: "assets/enemies/resonance-monk-banner.png", position: "center 40%" },
  speakerKraken: { src: "assets/enemies/speaker-kraken-banner.png", position: "center 38%" },
  deepTremorDjinn: { src: "assets/enemies/deep-tremor-djinn-banner.png", position: "center 36%" },
  soundholeLeviathan: { src: "assets/enemies/soundhole-leviathan-banner.png", position: "center 34%" },
};
...
function playBGM(type, meta = {}) {
  ...
  if (audioState.bgm.currentType === type && audioState.bgm.currentAudio && !audioState.bgm.currentAudio.paused) return;
  ...
  audio.play().catch((error) => {
    ...
    if (audioState.bgm.currentAudio === audio) {
...
function startBgmFadeIn(type, meta = {}, fadeId = audioState.bgm.fadeId) {
  ...
  audioState.bgm.currentType = type;
  audioState.bgm.currentAudio = nextAudio;
  console.log(bgmDebugLabel(type, meta));
  nextAudio.play().then(() => {
    const startedAt = performance.now();
    const fadeIn = (now) => {
    ...
    console.warn(`[BGM] ${bgmFileName(type)} could not play`, error);
    if (audioState.bgm.currentAudio === nextAudio) {
      audioState.bgm.currentAudio = null;
      audioState.bgm.currentType = null;
      audioState.bgm.fading = false;
    }
